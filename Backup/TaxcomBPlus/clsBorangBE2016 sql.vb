    ...
    Private Sub Page1()
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                dr = datHandler.GetDataReader("Select TC_KEY, TC_STATUTORY_INCOME, (cast(TC_DIVIDEND as money) + cast(TC_BUSINESSLOSS_BF as money)), TC_AGGREGATE_BUS_INCOME," _
                                ...
                                & " (cast(TC_INTEREST as money)+cast(TC_DISCOUNT as money)+cast(TC_RENTAL_ROYALTY as money)+cast(TC_PREMIUM as money)+cast(TC_PENSION_AND_ETC as money)+cast(TC_OTHER_GAIN_PROFIT as money)+cast(TC_SEC4A as money))," _
                                & " TC_REBATES, TC_DONATION_GIFT, TC_RELIEF," _
                                & " (cast(TC_INCOME_TAX_CHARGED as money) - cast(TC_TAX_SCH1_TAX as money)) as TC_TAX_CHARGED," _
                                & " TC_SEC110_DIVIDEND, TC_SEC110_OTHERS, (cast(TC_1 as money)+cast(TC_2 as money)) as TC_132_133, TC_5," _
                                & " TC_TAX_PAYABLE, TC_TAX_REPAYMENT, (cast(TC_INSTALLMENT_PAYMENT_SELF as money)+cast(TC_INSTALLMENT_PAYMENT_HW as money)) as B18," _
        ...
        Catch ex As Exception
            MsgBox(strErrorlog & " || " & ex.ToString, MsgBoxStyle.Critical)

...
#Region "Insert the page function here"
    ...
    Private Sub Page7()
        ...
        Try
            ...
            'End If
            dr.Close()
            dr = datHandler.GetDataReader("SELECT SUM(cast(CDBL(ADCA_UTIL as money)) AS TEMPNUM1, SUM(cast(CDBL(ADCA_BAL_CF as money)) AS TEMPNUM2" _

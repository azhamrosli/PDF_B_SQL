...
#Region "Insert the page function here"
    ...
    Private Sub Page1()
        ...
        Try
            ...
            'select tp_last_passport_no, tp_bwa, TP_WORKER_APPROVEDATE, TP_COM_ADD_STATUS,TP_HW_DOB from taxp_profile2
            dr = datHandler.GetDataReader("select * from taxp_profile2 where" _
            ...
            dr = datHandler.GetDataReader("Select TC_STATUTORY_INCOME, TC_BUSINESSLOSS_BF, TC_AGGREGATE_BUS_INCOME," _
                                & " TC_EMPLOYMENT_INCOME, TC_DIVIDEND, (cast(TC_INTEREST as money) + cast(TC_DISCOUNT as money) + cast(TC_RENTAL_ROYALTY as money)+ cast(TC_PREMIUM as money) + cast(TC_PENSION_AND_ETC as money) + cast(TC_PENSION_AND_ETC as money) + cast(TC_OTHER_GAIN_PROFIT as money) + cast(TC_SEC4A as money) + cast(TC_ADDITION_43 as money)), " _
            ...
            If dr.Read() Then
                ...
                If dr2.Read() Then
                    ...
                    If Not (IsDBNull(dr2.Item(0)) And IsDBNull(dr2.Item(1))) Then
                        'pdfFormFields.SetField(pdfFieldPath & "B7[0]", CDbl(dr2.Item(0)) + CDbl(dr2.Item(1)))
                        ' pdfFormFields.SetField(pdfFieldPath & "B7[0]", Fix((CDbl(dr2.Item(0))) + CDbl(dr2.Item(1))))
                        pdfFormFields.SetField(pdfFieldPath & "B7[0]", Fix((CDbl(dr2.Item(1)))))
                    End If

                    If Not IsDBNull(dr.Item(4)) Then
                        pdfFormFields.SetField(pdfFieldPath & "B8[0]", FormatFixedAmount((CDbl(dr.Item(5)) - CDbl(dr2.Item(0)) - CDbl(dr2.Item(1)))))
                    End If
                End If
            ...
            If dr.Read() Then
                ...
                If Not IsDBNull(dr("TC_TAX_BALANCE_INCOME")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E2b_1[0]", "2222222")
            ...
            ' === Part F === '
            Dim strSQLdata As String = "Select TC_TAX_PAYABLE, (cast(TC_INSTALLMENT_PAYMENT_SELF as money) + cast(TC_INSTALLMENT_PAYMENT_HW as money)),TC_BALANCE_TAX_PAYABLE, TC_BALANCE_TAX_OVERPAID From TAX_COMPUTATION Where TC_REF_NO= '" & pdfForm.GetRefNo & "' and TC_YA= '" & pdfForm.GetYA & "'"

            dr = datHandler.GetDataReader(strSQLdata)
    ...
    Private Sub Page2()
        ...
        Try
            ...
            Try
                ...
                Logx = "A14"
            Catch ex As Exception
                MsgBox(Logx & " || " & ex.ToString, MsgBoxStyle.Critical)
            End Try
                        ...
                        Select Case dr2("TCC_KEY")
                            ...
                            Case 15
                                ...
                                If Not IsDBNull(dr2("TCC_50")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_50"))) And Not Trim(dr2("TCC_50")) = "" Then
                                    ...
                                    ElseIf CDbl(Trim(dr2("TCC_50"))) = 8000 Then
                ...
                For i As Integer = 1 To 5
                    Select Case i
                        Case 1
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "D11a_2[0]", intArrayChild100(i) * 2000)
                            pdfFormFields.SetField(pdfFieldPath & "D11a_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11a_4[0]", intArrayChild50(i) * 1000)
                        Case 2
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_1[0]", intArrayChild100(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_2[0]", intArrayChild100(i) * 2000)
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_4[0]", intArrayChild50(i) * 1000)
                        Case 3
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_1[0]", intArrayChild100(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_2[0]", intArrayChild100(i) * 8000)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_4[0]", intArrayChild50(i) * 4000)
                        Case 4
                        ...
                        Case 5
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_2[0]", intArrayChild100(i) * 14000)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_4[0]", intArrayChild50(i) * 7000)
                    End Select
            ...
            dr = datHandler.GetDataReader("Select TC_STATUTORY_INCOME, TC_BUSINESSLOSS_BF, TC_AGGREGATE_BUS_INCOME," _
                                ...
                                & " TC_AGGREGATE_OTHER_SRC, TC_AGGREGATE_INCOME, TC_BUSINESSLOSS_CY,TC_BUSINESS,TC_PARTNERSHIP,TC_DONATION_GIFT," _
                                & " TC_TOTAL1 from tax_computation where" _
                                & " tc_ref_no ='" & pdfForm.GetRefNo & "' and tc_ya ='" & pdfForm.GetYA & "'")
            Logx = "B14"
            If dr.Read() Then
            ...
            If dr.Read Then
                ...
                If Not IsDBNull(dr("TC_INCOME_TRANSFER_FROM_HW")) Then
                    ' MsgBox("C35_2 AA" & FormatFixedAmount(dr("TC_INCOME_TRANSFER_FROM_HW")))
    ...
    Private Sub Page3()
        ...
        Try
            ...
            If dr.Read() Then
                dr2 = datHandler.GetDataReader("SELECT * FROM BUSINESS_SOURCE WHERE [BC_KEY] = '" _
            ...
            If dr.Read Then
                ...
                If Not IsDBNull(dr("TC_INCOME_TRANSFER_FROM_HW")) Then
                    'MsgBox("C35_2" & FormatFixedAmount(dr("TC_INCOME_TRANSFER_FROM_HW")))
                    pdfFormFields.SetField(pdfFieldPath & "C35_2[0]", FormatFixedAmount(dr("TC_INCOME_TRANSFER_FROM_HW")))
                Else
                    'MsgBox("C35_2 XXX")
                End If
    ...
    Private Sub Page4()
        ...
        Try
            ...
            If dr.Read() Then
                ...
                End If
                If Not IsDBNull(dr("TC_TAX_FIRST_INCOME")) Then
                    ' MsgBox("E2a_1" & FormatFixedAmount(dr("TC_TAX_FIRST_INCOME").ToString))
                    pdfFormFields.SetField(pdfFieldPath & "E2a_1[0]", FormatFixedAmount(dr("TC_TAX_FIRST_INCOME").ToString))
                Else
                    ' MsgBox("E2a_1 XXXX" & FormatFixedAmount(dr("TC_TAX_FIRST_INCOME").ToString))
                End If
                If Not IsDBNull(dr("TC_TAX_FIRST_TAX")) Then
                    Dim tmpDec As Decimal = IIf(IsNumeric(dr("TC_TAX_FIRST_TAX")), dr("TC_TAX_FIRST_TAX"), 0)

                    ' MsgBox("E2a_2" & dr("TC_TAX_FIRST_TAX").ToString)
                    pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", FormatFixedAmount(tmpDec.ToString().Substring(0, tmpDec.ToString().IndexOf(".")))) 'tmpDec.ToString("N0")) 'FormatFloatingAmount(dr("TC_TAX_FIRST_TAX").ToString, True))
                End If
                If Not IsDBNull(dr("TC_TAX_BALANCE_INCOME")) Then
                    Dim tmpDec As Decimal = IIf(IsNumeric(dr("TC_TAX_BALANCE_INCOME")), dr("TC_TAX_BALANCE_INCOME"), 0)

                    'pdfFormFields.SetField(pdfFieldPath & "E2b_1[0]", "11111111")
                    pdfFormFields.SetField(pdfFieldPath & "E2b_1[0]", FormatFixedAmount(dr("TC_TAX_BALANCE_INCOME"))) '
                End If
                If Not IsDBNull(dr("TC_TAX_BALANCE_RATE")) Then
                    'azham 1
                    If Len(dr("TC_TAX_BALANCE_RATE")) > 1 Then
    ...
    Private Sub Page5()
        ...
        Try
            ...
            ' === Part F === '
            dr = datHandler.GetDataReader("Select TC_TAX_PAYABLE, (cast(TC_INSTALLMENT_PAYMENT_SELF as money)  + cast(TC_INSTALLMENT_PAYMENT_HW as money)) as JoinPayment," _
            ...
            If dr.Read() Then
                ...
                If Not IsDBNull(dr.Item(1)) Then
                    If Not String.IsNullOrEmpty(dr.Item(1).ToString) Then
                        pdfFormFields.SetField(pdfFieldPath & "F2[0]", FormatFloatingAmount(FormatNumber(CDbl(dr("JoinPayment")), 2).ToString, True))
                    End If
                End If
                strLog = "K1.3"
                If Not IsDBNull(dr("TC_BALANCE_TAX_PAYABLE")) Then
            ...
            dr = datHandler.GetDataReader("select sum(cast(tca_cbl as money)) from tax_adjusted_loss where tc_key in " _
                        & "(select tc_key from tax_computation where " _
                        & "tc_ref_no ='" & pdfForm.GetRefNo & "' AND TC_YA='" & pdfForm.GetYA & "')")
            If dr.Read() Then
            ...
            strLog = "K6"
            'J2c
            dr = datHandler.GetDataReader("SELECT SUM(cast(ADCA_UTIL as money)),SUM(cast(ADCA_BAL_CF as money))" _
                                    & " From INCOME_ADJUSTED WHERE" _
                                    & " ADJ_REF_NO= '" & pdfForm.GetRefNo & "' AND ADJ_YA = '" & pdfForm.GetYA & "'")
            ...
            strLog = "K7"
            'J2f
            dr = datHandler.GetDataReader("SELECT SUM(cast(PSCA_UTIL as money)),SUM(cast(PSCA_BAL_CF as money))" _
                                    & " From INCOME_PARTNERSHIP WHERE" _
                                    & " PN_REF_NO= '" & pdfForm.GetRefNo & "' AND PN_YA = '" & pdfForm.GetYA & "'")
            ...
            strLog = "K9"
        Catch ex As Exception
            MsgBox(strLog & " || " & ex.ToString, MsgBoxStyle.Critical)
    ...
    Private Sub Page6()
        ...
        Try
            ...
            If dr.Read() Then
                ...
                'M22
                dr2 = datHandler.GetDataReader("SELECT [EXA_AMOUNT] FROM [PL_EXPENSES] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND EXA_PLTYPE = 53")
                Dim tmpInt As Decimal = 0
                While dr2.Read()
                    If Not IsDBNull(dr2.Item(0)) Then
                        tmpInt += CDec(dr2.Item("EXA_AMOUNT"))
                    End If
                End While
                dblTotalValue2 += tmpInt
                pdfFormFields.SetField(pdfFieldPath & "M22[0]", FormatFixedAmount(tmpInt))
                ...
                'D7A_19
                '  MsgBox("A")
                dr2 = datHandler.GetDataReader("SELECT [EXA_AMOUNT] FROM [PL_EXPENSES] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND EXA_PLTYPE = 54")
                ...
                End While
                dblTotalValue2 += tmpInt
                pdfFormFields.SetField(pdfFieldPath & "D7A_19[0]", FormatFixedAmount(tmpInt))
                ...
                'M23 - M24
                dblTemp = 0
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT))  FROM [PL_EXPENSES] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND (EXA_PLTYPE between 18 and 20 or EXA_PLTYPE = 46)")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = CDbl(dr2.Item(0))
                    End If
                ...
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_EXP_NONALLOWLOSS] WHERE [EXA_KEY] = " & dr("PL_KEY"))
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
                ...
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_EXP_NONALLOWEXPEND] WHERE [EXA_KEY] = " & dr("PL_KEY"))
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
                ...
                dr2.Close()
                strSQL = "L21"
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_EXP_PERSONAL] WHERE [EXA_KEY] = " & dr("PL_KEY"))
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
                ...
                'M26 Cal
                dblTemp = 0
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_EXPENSES] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND [EXA_DEDUCTIBLE]='No'")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
                ...
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_EXP_NONALLOWEXPEND] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND [EXA_DEDUCTIBLE]='No'")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
                ...
                dr2.Close()
                strSQL = "L23"
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_EXP_PERSONAL] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND [EXA_DEDUCTIBLE]='No'")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
                ...
                dr2 = datHandler.GetDataReader("SELECT sum(convert(money, EXA_AMOUNT)) FROM [PL_PRODUCTION_COST] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND [EXA_DEDUCTIBLE]='No' and (EXA_PLTYPE = 43 or EXA_PLTYPE = 45)")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If
            ...
            strSQL = "L25"
        Catch ex As Exception
            MsgBox(strSQL & " || " & ex.ToString, MsgBoxStyle.Critical)
        End Try
    End Sub
...
#Region "PNL Business Rules"
    ...
    Public Function OtherSource_GrossProfitLoss(ByVal cPNL_Key As Long, ByVal PNLCompany As String, ByVal PnLMainBusiness As String, ByVal strRefNo As String, ByVal strYA As String) As Double
        ...
        For J = 1 To UBound(arrPNL)
            ...
            dr.Close()
            ''*** Closing Stock
            dr = datHandler.GetDataReader("SELECT sum(cast([PL_AMOUNT] as money)) FROM [PL_CLOSESTOCK] WHERE [PL_KEY] = " & cPNL_Key & " AND [PL_SOURCENO] = '" & Trim(arrSource(J)) & "'")
            If dr.Read() Then

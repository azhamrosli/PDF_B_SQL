                ...
                For i As Integer = 1 To 5
                    Select Case i
                        ...
                        Case 5
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_2[0]", intArrayChild100(i) * 11000)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_4[0]", intArrayChild50(i) * 5500)
                    End Select

...
#Region "Insert the page function here"
    Private Sub Page1()
        ...
        Try
            ...
            'EDagang
            pdfFormFields.SetField(pdfFieldPath & "D7A_1", ds.Tables(0).Rows(0).Item(6).ToString)
            'JKDM
            pdfFormFields.SetField(pdfFieldPath & "D7A_3", ds.Tables(0).Rows(0).Item(7).ToString)
            'GST
            pdfFormFields.SetField(pdfFieldPath & "D7A_4", ds.Tables(0).Rows(0).Item(8).ToString)

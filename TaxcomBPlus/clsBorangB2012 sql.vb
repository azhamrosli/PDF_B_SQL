    ...
    Private Sub Page6()
        ...
        Try
            ...
            If dr.Read() Then
                ...
                dr2 = datHandler.GetDataReader("SELECT [ADJ_OTHER] FROM [INCOME_ADJUSTED] WHERE [ADJ_REF_NO] = '" & pdfForm.GetRefNo & "' AND [ADJ_YA] = '" & pdfForm.GetYA & "' ")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        dblTemp = dblTemp + CDbl(dr2.Item(0))
                    End If

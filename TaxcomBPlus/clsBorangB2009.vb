...
#Region "Insert the page function here"
    ...
    Private Sub Page1()
        ...
        Try
            ...
            ds = datHandler.GetData("SELECT SUM(cast(TCA_CBL as money)) FROM TAX_ADJUSTED_LOSS WHERE TC_KEY IN (SELECT TC_KEY FROM TAX_COMPUTATION WHERE TC_REF_NO=? AND TC_YA=?)", prmOledb)
